...
static ngx_int_t ngx_http_variable_nguyenx_version(ngx_http_request_t *r,
    ngx_http_variable_value_t *v, uintptr_t data);
...
static ngx_http_variable_t  ngx_http_core_variables[] = {
    ...
    { ngx_string("nguyenx_version"), NULL, ngx_http_variable_nguyenx_version,
      0, 0, 0 },
...
static ngx_int_t
ngx_http_variable_nguyenx_version(ngx_http_request_t *r,
    ngx_http_variable_value_t *v, uintptr_t data)
{
