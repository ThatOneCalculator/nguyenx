...
"<hr><center>" nguyenx_VER "</center>" CRLF
"</body>" CRLF
"</html>" CRLF
;
...
"<hr><center>" nguyenx_VER_BUILD "</center>" CRLF
"</body>" CRLF
"</html>" CRLF
;
...
ngx_http_special_response_handler(ngx_http_request_t *r, ngx_int_t error)
{
    ...
    } else if (error >= NGX_HTTP_nguyenx_CODES
               && error < NGX_HTTP_LAST_5XX)
    {
        /* 49X, 5XX */
        err = error - NGX_HTTP_nguyenx_CODES + NGX_HTTP_OFF_5XX;
        switch (error) {
            case NGX_HTTP_TO_HTTPS:
            case NGX_HTTPS_CERT_ERROR:
            case NGX_HTTPS_NO_CERT:
