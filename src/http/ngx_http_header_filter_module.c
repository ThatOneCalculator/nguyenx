...
static u_char ngx_http_server_string[] = "Server: nguyenx" CRLF;
static u_char ngx_http_server_full_string[] = "Server: " nguyenx_VER CRLF;
static u_char ngx_http_server_build_string[] = "Server: " nguyenx_VER_BUILD CRLF;
